...
<template>
  <div v-if="isLogged">
    <div v-if="hasBooks">
      ...
      <div class="grid gap-[16px] justify-items-center grid-cols-3 md:grid-cols-[repeat(auto-fit,minmax(9rem,1fr))]">
        <div
          v-for="book in books"
          :key="book.id"
        >
    ...
    <div
      v-if="events.length > 0"
      class="grid gap-[12px] grid-cols-3 md:grid-cols-[repeat(auto-fit,minmax(9rem,1fr))]"
    >
      <div
