...
<template>
  <section id="edit-modal-content" class="edit-modal jl-modal p-0 relative flex flex-col max-h-[85vh] overflow-visible" style="--modal-width: min(676px, calc(100vw - 24px)); --modal-min-height: 12rem;">
    <!-- Sticky Header -->
